...
private:
    void bellek_tamsayi(){
        matris = (int **)malloc( 20 * sizeof(int) );
        if( matris == NULL )
            printf( "Yetersiz bellek!" ); // Daha sonra sutun sayisi icin yer olusturdum
        for(int i = 0; i < 20; i++ ) {
            matris[i] = (int*)malloc( 20 * sizeof(int) );
            if( matris[i] == NULL )
                printf( "Yetersiz bellek!" );
            }
            }
    void trans(){
        transpoz = (int **)malloc( 20 * sizeof(int) );
        if( transpoz == NULL )
            printf( "Yetersiz bellek!" );
        for(int i = 0; i < 20; i++ ) {
            transpoz[i] = (int*)malloc( 20 * sizeof(int) );
            if( transpoz[i] == NULL )
                printf( "Yetersiz bellek!" );
            }
            }
    void birim(){
        birim_matris = (int **)malloc( 20 * sizeof(int) );
        if( birim_matris == NULL )
            printf( "Yetersiz bellek!" );
        for(int i = 0; i < 20; i++ ) {
            birim_matris[i] = (int*)malloc( 20 * sizeof(int) );
            if( birim_matris[i] == NULL )
                printf( "Yetersiz bellek!" );
            }
            }
    void random(){
        random_matris = (int **)malloc( 20 * sizeof(int) );
        if( random_matris == NULL )
            printf( "Yetersiz bellek!" );
        for(int i = 0; i < 20; i++ ) {
            random_matris[i] = (int*)malloc( 20 * sizeof(int) );
